...
fminf_d(float a, float b)
{
  return a < b ? a : b;
}

inline __host__ __device__ float
fmaxf_d(float a, float b)
{
  return a > b ? a : b;
}
...
inline __host__ __device__ struct mat3
make_mat3(float s)
{
  return {
    make_float3(s), make_float3(s), make_float3(s),
  };
}

inline __host__ __device__ struct mat3
make_mat3(float3 x, float3 y, float3 z)
{
  return { x, y, z };
}
...
inline __host__ __device__ float3 operator*(const mat3& m, const float3& a)
{
  return make_float3(m.x.x * a.x + m.y.x * a.y + m.z.x * a.z,
                     m.x.y * a.x + m.y.y * a.y + m.z.y * a.z,
                     m.x.z * a.x + m.y.z * a.y + m.z.z * a.z);
}
...
{
    return make_int4(max_d(a.x,b.x), max_d(a.y,b.y), max_d(a.z,b.z),
max_d(a.w,b.w));
}

inline __host__ __device__ uint2 max(uint2 a, uint2 b)
{
    return make_uint2(max_d(a.x,b.x), max_d(a.y,b.y));
}
inline __host__ __device__ uint3 max(uint3 a, uint3 b)
{
    return make_uint3(max_d(a.x,b.x), max_d(a.y,b.y), max_d(a.z,b.z));
}
inline __host__ __device__ uint4 max(uint4 a, uint4 b)
{
    return make_uint4(max_d(a.x,b.x), max_d(a.y,b.y), max_d(a.z,b.z),
max_d(a.w,b.w));
}*/
