...
namespace texture
{
  ...
  {
    inline float *
    copy_face(float *dst, const float *cubecross,
      unsigned int img_width, unsigned int x_offset,
      unsigned int y_offset, unsigned in_nb_comp, unsigned int out_nb_comp)
    {
